  ...
  openalex: {
    ...
    filters: [
      ...
      { key: 'field', label: 'Field', type: 'select', options: [
        ...
        { value: 'Agricultural and Biological Sciences',       label: 'Agricultural and Biological Sciences' },
        { value: 'Arts and Humanities',                        label: 'Arts and Humanities' },
        { value: 'Biochemistry, Genetics and Molecular Biology', label: 'Biochemistry, Genetics and Molecular Biology' },
        { value: 'Business, Management and Accounting',        label: 'Business, Management and Accounting' },
        { value: 'Chemical Engineering',                       label: 'Chemical Engineering' },
        { value: 'Chemistry',                                  label: 'Chemistry' },
        { value: 'Computer Science',                           label: 'Computer Science' },
        { value: 'Decision Sciences',                          label: 'Decision Sciences' },
        { value: 'Dentistry',                                  label: 'Dentistry' },
        { value: 'Earth and Planetary Sciences',               label: 'Earth and Planetary Sciences' },
        { value: 'Economics, Econometrics and Finance',        label: 'Economics, Econometrics and Finance' },
        { value: 'Energy',                                     label: 'Energy' },
        { value: 'Engineering',                                label: 'Engineering' },
        { value: 'Environmental Science',                      label: 'Environmental Science' },
        { value: 'Health Professions',                         label: 'Health Professions' },
        { value: 'Immunology and Microbiology',                label: 'Immunology and Microbiology' },
        { value: 'Materials Science',                          label: 'Materials Science' },
        { value: 'Mathematics',                                label: 'Mathematics' },
        { value: 'Medicine',                                   label: 'Medicine' },
        { value: 'Neuroscience',                               label: 'Neuroscience' },
        { value: 'Nursing',                                    label: 'Nursing' },
        { value: 'Pharmacology, Toxicology and Pharmaceutics', label: 'Pharmacology, Toxicology and Pharmaceutics' },
