...
# Configuration
DB_PATH = os.path.expanduser("./data/factbook/factbook.db")  # Change this
TMP_DIR = "/tmp/factbook_json"

# Clone the factbook JSON repo
if os.path.exists(TMP_DIR):
    shutil.rmtree(TMP_DIR)
subprocess.run(["git", "clone", "https://github.com/factbook/factbook.json.git", TMP_DIR], check=True)
