...
def main() -> int:
    ...
    parser.add_argument("--limit", type=int, default=None,
                        help="Process at most N docs (testing). "
                             "Default None = full corpus (~513 pages).")
    parser.add_argument("--reset", action="store_true",
                        help="Wipe python_docs_rag.db and rebuild from scratch.")
    ...
    return run_indexer(
        ...
        rag_db_path=RAG_DB,
        extractor=lambda conn: python_docs_rag_extract.iter_docs(conn, limit=args.limit),
